	...
	<?php
		...
		while ($uid < $count)
		{
			...
			if (is_numeric($lat) && is_numeric($lon))
			{
				...
				echo "marker.bindPopup(\x22<h3>".$description." Now+Then</h3><div ID='bigdiv' style='width:320px;height:240px' ><div id='spinner".$uid."' class='spinner'><img id='img-spinner".$uid."' src='assets/images/spinner.gif' alt='Loading'/></div><div id='natpair".$uid."' style='display:none' ><ul class='images'><li><img ID='thenImage12' style='opacity:0' src='".$then.".jpg' height='240px' width='300px'></img></li><li><img ID='nowImage12' style='opacity:1' src='".$now.".jpg' height='240px' width='300px'></img></li></ul></div></div><div id='slider-bg' title='Slider'><div id='slider-thumb'><img src='http://yui.yahooapis.com/2.9.0/build/slider/assets/thumb-n.gif'></div></div>\x22).openPopup();";
			}
