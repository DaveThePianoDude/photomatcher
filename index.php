		...
		while ($row = pg_fetch_row($result))
		{
			...
			if (is_numeric($lat) && is_numeric($lon) && $x < $PHOTO_THRESHOLD)
			{
				...
				<div ID='bigdiv' style='width:320px;height:240px' >
					<div id='spinner".$uid."' class='spinner'>
						<img id='img-spinner".$uid."' src='assets/images/spinner.gif' alt='Loading'/>
					</div>
					<div id='natpair".$uid."'>
						<ul class='images'>
							<li>
								<img ID='thenImage12' style='opacity:0' src='thenimage".$uid.".jpg' height='240px' width='300px'></img>
							</li>
							<li>
								<img ID='nowImage12' style='opacity:1' src='nowimage".$uid.".jpg' height='240px' width='300px'></img>
							</li>
						</ul>
					</div>
				</div>
